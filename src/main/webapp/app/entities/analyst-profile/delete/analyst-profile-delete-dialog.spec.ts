...
import { AnalystProfileDeleteDialog } from './analyst-profile-delete-dialog';

describe('AnalystProfile Management Delete Component', () => {
  let comp: AnalystProfileDeleteDialog;
  let fixture: ComponentFixture<AnalystProfileDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AnalystProfileDeleteDialog);
