...
import { CiAlertDeleteDialog } from './ci-alert-delete-dialog';

describe('CiAlert Management Delete Component', () => {
  let comp: CiAlertDeleteDialog;
  let fixture: ComponentFixture<CiAlertDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CiAlertDeleteDialog);
